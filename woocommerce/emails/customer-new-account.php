...
<p><?php printf( esc_html__( 'Multumim pentru crearea contului pe ConnectMobile. Numele tau de utilizator este %2$s. Iti poti accesa contul sau schimba parola pe: %3$s' , 'woocommerce' ), esc_html( $blogname ), '<strong>' . esc_html( $user_login ) . '</strong>', make_clickable( esc_url( wc_get_page_permalink( 'myaccount' ) ) ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
